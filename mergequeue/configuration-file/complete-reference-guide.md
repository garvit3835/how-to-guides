...
| **use\_affected\_targets**                 | Boolean                                 | If enabled, allows using [affected targets](../affected-targets/) in your repo.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| **use\_fast\_forwarding**                  | Boolean                                 | If enabled, uses [fast forwarding](../fast-forwarding.md) to merge PRs.                                                                                                                                                                                                                                                                                                                                                                                                                                            |
